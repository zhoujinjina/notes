...
![image-20210514225741114](./assets/855d9e0cd0c8ed56c78869e22744fc8d.png)
...
- <mark>name</mark> ：指定的数据的名称
  ...
  - <mark>description</mark>：表示网站的描述信息
    ...
    ![image-20210514230338273](./assets/3730201c7f36c90a23f8683d8e8b1cc4.png)

- <mark>content</mark> ：指定的数据的内容，会作为搜索结果的超链接上的文字显示

打开 Zeal 手册（前端开发准备中做过介绍）

![image-20210514230900103](./assets/69244610084684cb6f8d3fc544a7dd03.png)
...
![image-20210514231126506](./assets/03688356f8a9847bfe15f80fe5405bd0.png)
...
![image-20210515212349676](./assets/f1b33334fe6d180469fa616c3c083196.png)
...
![image-20210515233449533](./assets/f5833d8d3eda58ef6dd16955604238a7.png)
...
![image-20210516010618514](./assets/20d0e02a6af2a2497a6ccb45657f5d8d.png)

### 其他

通过`iframe`和`embed`的方式引入视频。以某艺为例，提供了视频链接的 HTML 代码和通用代码

![image-20210516011905816](./assets/f2001068e8a632e4191bb7372e1eade2.png)

![image-20210516011837229](./assets/faf8c2e1c98d340dd5140f4428316a03.png)
